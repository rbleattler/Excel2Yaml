...
// File: src\Excel2Yaml.def.ts
/**
 * @module Excel2YAML
 * @mergeModuleWith Excel2YAML
 * @description
...
namespace Excel2YAML {
   ...
   */type TemplateNode = Excel2YAML.MappingNode | Excel2YAML.GroupingNode | string | number | boolean;
}
